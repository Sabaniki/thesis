...
\input{src/00_abstract.ja}
\thispagestyle{plain}
\clearpage

\input{src/00_abstract.en}
\thispagestyle{plain}
\clearpage
...
\input{src/01_introduction.ja}
\input{src/02_related_works.ja}
\input{src/03_design_and_impl.ja}
\input{src/04_evaluation.ja}
\input{src/05_conclusion.ja}
\input{src/09_thanks.ja.tex}
