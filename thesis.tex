...
% タイトル
\def\title{Linux SRv6 ルーティングインフラにおける SR-Aware ネットワーク機能としての Netfilter の統合}
% 英語タイトル
...
\input{src/000_abstract.ja}
\thispagestyle{plain}
\clearpage

\input{src/000_abstract.en}
\thispagestyle{plain}
\clearpage
...
\input{src/010_introduction.ja}
\input{src/020_related_works.ja}
\input{src/030_design_and_impl.ja}
\input{src/040_evaluation.ja}
\input{src/050_conclusion.ja}
